...
def helper(port):
    ...
    mid = 1
    publish_packet = mqtt_packets.gen_publish("subpub/qos2/receive/maximum1", qos=2, mid=mid, payload="message1", proto_ver=5)
    ...
    mid = 2
    publish_packet2 = mqtt_packets.gen_publish("subpub/qos2/receive/maximum1", qos=2, mid=mid, payload="message2", proto_ver=5)
    ...
    mid = 3
    publish_packet3 = mqtt_packets.gen_publish("subpub/qos2/receive/maximum1", qos=2, mid=mid, payload="message3", proto_ver=5)
...
def do_test(start_broker):
    ...
    mid = 1
    subscribe_packet = mqtt_packets.gen_subscribe(mid, "subpub/qos2/receive/maximum1", 2, proto_ver=5)
    suback_packet = mqtt_packets.gen_suback(mid, 2, proto_ver=5)

    mid = 1
    publish_packet1 = mqtt_packets.gen_publish("subpub/qos2/receive/maximum1", qos=2, mid=mid, payload="message1", proto_ver=5)
