 ...
 * 
 * 1) bridge_name = "default_v1"
 *       username = "Albert"
 *       password = "Einstein"
 *        returns = MOSQ_ERR_SUCCESS
 *      
 * 2) bridge_name = "defer_v1"
 *       username = <unchanged>
 *       password = <unchanged>
 *        returns = MOSQ_ERR_PLUGIN_DEFER
 *      
 * 3) bridge_name = "denied_v1"
 *       username = <unchanged>
 *       password = <unchanged>
...
#define PLUGIN_NAME "bridge_auth_v1"
#define PLUGIN_VERSION "0.0.1"

#define AUTH_PLUGIN_USERNAME "Albert"
#define AUTH_PLUGIN_PASSWORD "Einstein"

#define TEST_SETUP_DEFAULT "default_v1"
#define TEST_SETUP_DEFER "defer_v1"
#define TEST_SETUP_DENIED "denied_v1"

MOSQUITTO_PLUGIN_DECLARE_VERSION(5);

static mosquitto_plugin_id_t* mosq_pid = NULL;

static int basic_auth_v1_callback(int event, void* event_data, void* userdata)
{
  ...
  /* For all *_v2 connections MOSQ_ERR_PLUGIN_DEFER will be returned */
  if (NULL != strstr(ed->bridge_name, "_v2")) {
      return MOSQ_ERR_PLUGIN_DEFER;
  }
                          ...
                          int opt_count)
{
  ...
  return mosquitto_callback_register(mosq_pid, MOSQ_EVT_LOAD_BRIDGE_CRED, basic_auth_v1_callback, NULL, NULL);
}
