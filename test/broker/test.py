...
tests = [
    ...
    (2, './06-bridge-connack-qos-not-supported.py'),
    (2, './06-bridge-connack-retain-not-supported.py'),
    (2, './06-bridge-connack-v4-error.py'),
    (2, './06-bridge-connack-v5-bad-protocol-version.py'),
    (2, './06-bridge-connack-v5-error.py'),
    ...
    (2, './08-ssl-bridge.py'),
    (1, './08-ssl-connect-cert-auth-crl.py'),
    (1, './08-ssl-connect-cert-auth-expired.py'),
    (1, './08-ssl-connect-cert-auth-expired-allowed.py'),
    (1, './08-ssl-connect-cert-auth-revoked.py'),
    (1, './08-ssl-connect-cert-auth-without.py'),
    ...
    (2, './15-persist-client-msg-in-v3-1-1.py', 'persist_sqlite'),
    (2, './15-persist-client-msg-in-v5-0.py', 'persist_sqlite'),
    (2, './15-persist-client-msg-out-clear-v3-1-1.py', 'persist_sqlite'),
    (2, './15-persist-client-msg-out-dup-v3-1-1.py', 'persist_sqlite'),
    (2, './15-persist-client-msg-out-queue-v3-1-1.py', 'persist_sqlite'),
    (2, './15-persist-client-msg-out-v3-1-1-db.py', 'persist_sqlite'),
    (2, './15-persist-client-msg-out-v3-1-1.py', 'persist_sqlite'),
    ...
    (2, './15-persist-retain-v5-0.py', 'persist_sqlite'),
    (2, './15-persist-subscription-v3-1-1.py', 'persist_sqlite'),
    (2, './15-persist-subscription-v5-0.py', 'persist_sqlite'),
